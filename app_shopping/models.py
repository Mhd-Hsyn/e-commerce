...
class Admin(BaseModel):
    ...
    image = models.ImageField(
        upload_to="AdminImage/",
        height_field=None,
        width_field=None,
        max_length=None,
        default="AdminImage/dummyadmin.png",
    )
...
class Seller(BaseModel):
    ...
    shop_image = models.ImageField(
        upload_to="SellerImage/",
        height_field=None,
        width_field=None,
        max_length=None,
        default="SellerImage/dummyseller.png",
    )
    description = models.TextField(default="")
...
class Product(BaseModel):
    ...
    sub_category = models.ForeignKey(
        Product_SubCategory, on_delete=models.CASCADE, blank=True, null=True
    )
    ...
    discount_startdate = models.DateTimeField(
        auto_now=False, auto_now_add=False, default=None, null=True, blank=True
    )
    discount_enddate = models.DateTimeField(
        auto_now=False, auto_now_add=False, default=None, null=True, blank=True
    )
...
class Sale(BaseModel):
    ...
    sale_percent = models.IntegerField(
        ...
        help_text="Enter the sale percentage",
    )
    sale_startdate = models.DateTimeField(
        auto_now=False, auto_now_add=False, default=None, null=True, blank=True
    )
    sale_enddate = models.DateTimeField(
        auto_now=False, auto_now_add=False, default=None, null=True, blank=True
    )
...
class Customer(BaseModel):
    ...
    profile_image = models.ImageField(
        ...
        width_field=None,
        max_length=None,
        default="CustomerImage/dummycustomer.png",
    )
    password = models.TextField(null=False)
    Otp = models.IntegerField(default=0)
    OtpCount = models.IntegerField(default=0)
...
class Orders(BaseModel):
    payment_choices = [("paypal", "paypal"), ("card", "card")]
    customer = models.ForeignKey(
        Customer, on_delete=models.CASCADE, blank=True, null=True
    )
    ...
    payment_method = models.CharField(
        max_length=50, choices=payment_choices, default=""
    )
    payment_status = models.BooleanField(default=False)
    payment_date = models.DateTimeField(
        auto_now=False, auto_now_add=False, blank=True, null=True
    )  # payment date added only when payment status becomes True
